      ...
      <section className="hakkimda-content" style={{ padding: '80px 0', background: '#0a0a0a' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 2rem' }}>
          <div className="hakkimda-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'flex-start' }}>
            ...
            {/* Sol — Biyografi */}
            <div>
              <h2 style={{ fontSize: '4rem', fontWeight: 900, textTransform: 'uppercase', color: 'white', marginBottom: '2rem' }}>
            ...
            <div>
              ...
              {/* Sertifikalar */}
              <h2 style={{ fontSize: '4rem', fontWeight: 900, textTransform: 'uppercase', color: 'white', marginBottom: '1.5rem' }}>
